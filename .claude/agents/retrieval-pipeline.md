...
description: Build and review the chum-mem memory derivation and retrieval path, including compaction, embeddings, hybrid search, context pack assembly, and provenance preservation. Use for implementing workers, search ranking, retrieval contracts, or token-budget aware context assembly.
