---
name: security-qa
description: review chum-mem for tenant isolation, token safety, auth misuse, ingestion correctness, and retrieval regressions. use when codex needs to test or review security-sensitive backend and dashboard changes, especially around rls, tokens, provenance, and cross-team data access.
---
